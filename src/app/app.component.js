...
var AppComponent = function () {
    var _classDecorators = [(0, core_1.Component)({
            ...
            imports: [standalone_1.IonApp, standalone_1.IonRouterOutlet],
        })];
    ...
    var AppComponent = _classThis = /** @class */ (function () {
        ...
        AppComponent_1.prototype.initPush = function () {
            var _this = this;
            push_notifications_1.PushNotifications.requestPermissions().then(function (result) {
                if (result.receive === 'granted') {
                    push_notifications_1.PushNotifications.register();
                }
            });
            ...
            push_notifications_1.PushNotifications.addListener('pushNotificationReceived', function (notification) {
                alert('Notificación recibida: ' + JSON.stringify(notification));
            });
            push_notifications_1.PushNotifications.addListener('pushNotificationActionPerformed', function (action) {
